namespace ConfectioneryDepartmentApp.Forms.Report {
  partial class CustomersRankingBySpentForm {
    /// <summary>
    ...
    private void InitializeComponent() {
      ...
      this.RaportTBox.TabIndex = 111;
      this.RaportTBox.TabStop = false;
      // 
      // CustomersRankingBySpentForm
      // 
      ...
      this.Name = "CustomersRankingBySpentForm";
      this.ShowIcon = false;
      this.Text = "Рейтинг клієнтів за обсягом покупок із урахуванням знижок";
