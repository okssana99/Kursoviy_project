...
namespace ConfectioneryDepartmentApp.Forms.Controls {
  public partial class OrderFinishForm : Form {
    ...
    private void DataLoad() {
      ...
      try {
        _OrderItem = _OrderProvider.GetFinishOrders();
    ...
    private void OrderItemGridView_DataError(object sender, DataGridViewDataErrorEventArgs e) {
